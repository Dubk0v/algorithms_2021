...
def haffman_code(haffman_tree, letter_code=''):
    if haffman_tree.is_leaf():
        code.update({haffman_tree.letter: letter_code})
    else:
        haffman_code(haffman_tree.left, letter_code=letter_code + '0')
        haffman_code(haffman_tree.right, letter_code=letter_code + '1')
    return code
...
haffman_tree = haffman_tree(make_nodes(s))
haffman_code = haffman_code(haffman_tree)
print(haffman_code)
